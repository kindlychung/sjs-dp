...
/** @constructor */
function $c_Lorg_querki_jsext_JSOptionBuilder() {
  $c_O.call(this);
  this.copy$1 = null
}
$c_Lorg_querki_jsext_JSOptionBuilder.prototype = new $h_O();
$c_Lorg_querki_jsext_JSOptionBuilder.prototype.constructor = $c_Lorg_querki_jsext_JSOptionBuilder;
/** @constructor */
function $h_Lorg_querki_jsext_JSOptionBuilder() {
  /*<skip>*/
}
$h_Lorg_querki_jsext_JSOptionBuilder.prototype = $c_Lorg_querki_jsext_JSOptionBuilder.prototype;
$c_Lorg_querki_jsext_JSOptionBuilder.prototype.jsOpt__T__O__Lorg_querki_jsext_JSOptionBuilder = (function(name, opt) {
  return $as_Lorg_querki_jsext_JSOptionBuilder(this.copy$1.apply__O__O(this.dict$2.$$plus__T2__sci_Map(new $c_T2().init___O__O(name, opt))))
});
$c_Lorg_querki_jsext_JSOptionBuilder.prototype.toString__T = (function() {
  var jsx$1 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["{\\n", "\\n}"]));
  var this$1 = this.dict$2;
  ...
  var this$5 = new $c_sc_MapLike$$anon$1().init___sc_MapLike(this$4);
  while (this$5.iter$2.hasNext__Z()) {
    var arg1 = this$5.next__O();
    var key = $as_T(arg1);
    b.$$plus$eq__O__scm_Builder(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["  ", " = ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([key, $objectToString(this.dict$2.apply__O__O(key))])))
  };
  return jsx$1.s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_sc_TraversableOnce(b.result__O()).mkString__T__T("\n")]))
});
$c_Lorg_querki_jsext_JSOptionBuilder.prototype.init___F1 = (function(copy) {
  this.copy$1 = copy;
  return this
});
$c_Lorg_querki_jsext_JSOptionBuilder.prototype.$$undresult__sjs_js_Object = (function() {
  var this$2 = $m_sjs_js_JSConverters$JSRichGenMap$();
  var $$this = this.dict$2;
...
function $is_Lorg_querki_jsext_JSOptionBuilder(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lorg_querki_jsext_JSOptionBuilder)))
}
function $as_Lorg_querki_jsext_JSOptionBuilder(obj) {
  return (($is_Lorg_querki_jsext_JSOptionBuilder(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "org.querki.jsext.JSOptionBuilder"))
}
function $isArrayOf_Lorg_querki_jsext_JSOptionBuilder(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lorg_querki_jsext_JSOptionBuilder)))
}
function $asArrayOf_Lorg_querki_jsext_JSOptionBuilder(obj, depth) {
  return (($isArrayOf_Lorg_querki_jsext_JSOptionBuilder(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lorg.querki.jsext.JSOptionBuilder;", depth))
}
/** @constructor */
function $c_Lorg_querki_jsext_package$() {
  $c_O.call(this);
  this.noOpts$1 = null
}
$c_Lorg_querki_jsext_package$.prototype = new $h_O();
$c_Lorg_querki_jsext_package$.prototype.constructor = $c_Lorg_querki_jsext_package$;
/** @constructor */
function $h_Lorg_querki_jsext_package$() {
  /*<skip>*/
}
$h_Lorg_querki_jsext_package$.prototype = $c_Lorg_querki_jsext_package$.prototype;
$c_Lorg_querki_jsext_package$.prototype.init___ = (function() {
  $n_Lorg_querki_jsext_package$ = this;
  this.noOpts$1 = $m_sci_Map$EmptyMap$();
  return this
});
var $d_Lorg_querki_jsext_package$ = new $TypeData().initClass({
  Lorg_querki_jsext_package$: 0
}, false, "org.querki.jsext.package$", {
  Lorg_querki_jsext_package$: 1,
  O: 1
});
$c_Lorg_querki_jsext_package$.prototype.$classData = $d_Lorg_querki_jsext_package$;
var $n_Lorg_querki_jsext_package$ = (void 0);
function $m_Lorg_querki_jsext_package$() {
  if ((!$n_Lorg_querki_jsext_package$)) {
    $n_Lorg_querki_jsext_package$ = new $c_Lorg_querki_jsext_package$().init___()
  };
  return $n_Lorg_querki_jsext_package$
}
/** @constructor */
function $c_Lvu_co_kaiyin_sjsdp_Main$() {
  $c_O.call(this)
}
$c_Lvu_co_kaiyin_sjsdp_Main$.prototype = new $h_O();
$c_Lvu_co_kaiyin_sjsdp_Main$.prototype.constructor = $c_Lvu_co_kaiyin_sjsdp_Main$;
/** @constructor */
function $h_Lvu_co_kaiyin_sjsdp_Main$() {
  /*<skip>*/
}
$h_Lvu_co_kaiyin_sjsdp_Main$.prototype = $c_Lvu_co_kaiyin_sjsdp_Main$.prototype;
$c_Lvu_co_kaiyin_sjsdp_Main$.prototype.main__V = (function() {
...
$c_Lvu_co_kaiyin_sjsdp_Main$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lvu_co_kaiyin_sjsdp_Main$ = new $TypeData().initClass({
  Lvu_co_kaiyin_sjsdp_Main$: 0
}, false, "vu.co.kaiyin.sjsdp.Main$", {
  Lvu_co_kaiyin_sjsdp_Main$: 1,
  O: 1
});
$c_Lvu_co_kaiyin_sjsdp_Main$.prototype.$classData = $d_Lvu_co_kaiyin_sjsdp_Main$;
var $n_Lvu_co_kaiyin_sjsdp_Main$ = (void 0);
function $m_Lvu_co_kaiyin_sjsdp_Main$() {
  if ((!$n_Lvu_co_kaiyin_sjsdp_Main$)) {
    $n_Lvu_co_kaiyin_sjsdp_Main$ = new $c_Lvu_co_kaiyin_sjsdp_Main$().init___()
  };
  return $n_Lvu_co_kaiyin_sjsdp_Main$
}
$e["vu"] = ($e["vu"] || {});
$e["vu"]["co"] = ($e["vu"]["co"] || {});
$e["vu"]["co"]["kaiyin"] = ($e["vu"]["co"]["kaiyin"] || {});
$e["vu"]["co"]["kaiyin"]["sjsdp"] = ($e["vu"]["co"]["kaiyin"]["sjsdp"] || {});
$e["vu"]["co"]["kaiyin"]["sjsdp"]["Main"] = $m_Lvu_co_kaiyin_sjsdp_Main$;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
...
/** @constructor */
function $c_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder() {
  $c_Lorg_querki_jsext_JSOptionBuilder.call(this);
  this.dict$2 = null
}
$c_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder.prototype = new $h_Lorg_querki_jsext_JSOptionBuilder();
$c_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder.prototype.constructor = $c_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder;
/** @constructor */
function $h_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder() {
  /*<skip>*/
}
$h_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder.prototype = $c_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder.prototype;
$c_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder.prototype.init___sci_Map = (function(dict) {
  this.dict$2 = dict;
  $c_Lorg_querki_jsext_JSOptionBuilder.prototype.init___F1.call(this, new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$1$2) {
    var x$1 = $as_sci_Map(x$1$2);
    return new $c_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder().init___sci_Map(x$1)
  })));
  return this
});
function $is_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder)))
}
function $as_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder(obj) {
  return (($is_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "vu.co.kaiyin.sjsdp.optbuilder.package$BootstrapDatepickerOptionBuilder"))
}
function $isArrayOf_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder)))
}
function $asArrayOf_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder(obj, depth) {
  return (($isArrayOf_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lvu.co.kaiyin.sjsdp.optbuilder.package$BootstrapDatepickerOptionBuilder;", depth))
}
var $d_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder = new $TypeData().initClass({
  Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder: 0
}, false, "vu.co.kaiyin.sjsdp.optbuilder.package$BootstrapDatepickerOptionBuilder", {
  Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder: 1,
  Lorg_querki_jsext_JSOptionBuilder: 1,
  O: 1
});
$c_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder.prototype.$classData = $d_Lvu_co_kaiyin_sjsdp_optbuilder_package$BootstrapDatepickerOptionBuilder;
...
//# sourceMappingURL=sjs-dp-fastopt.js.map
